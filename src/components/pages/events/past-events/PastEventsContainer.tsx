import { PastEventsPresentation } from './'
...
const sampleEvents = [
  {
    ...
    copy: 'Explore how innovative coworking spaces are transforming traditional work environments.',
  ...
  },
  {
    ...
    copy: 'A feature on the emerging artists in our community and how they are shaping the local art scene.',
  ...
  },
  {
    ...
    copy: 'Highlights from our recent networking events and tips for making the most out of them.',
    dateTime: '2025-02-17T09:30:00',
  },
]

const PastEventsContainer = () => {
  return sampleEvents.length > 3 ? <PastEventsPresentation events={sampleEvents} /> : null
}
