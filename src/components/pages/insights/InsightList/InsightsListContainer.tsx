import { InsightsListPresentation } from '.'

const sampleBlogs = [
  {
    id: '1',
    imageUrl:
      'https://images.unsplash.com/photo-1736762046814-678901a05bd3?w=800&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxmZWF0dXJlZC1waG90b3MtZmVlZHwxOHx8fGVufDB8fHx8fA%3D%3D',
    ...
    slug: 'creative-spaces-redefining-work-environments',
  },
  {
    id: '2',
    imageUrl:
    ...
    slug: 'spotlight-on-local-artists',
  },
  {
    id: '3',
    imageUrl:
    ...
    slug: 'networking-events-at-creative-hub',
  },
  {
    id: '4',
    imageUrl:
    ...
    slug: 'design-trends-for-modern-workspaces',
  },
  {
    id: '5',
    imageUrl:
    ...
    slug: 'community-collaboration-projects',
  },
  {
    id: '6',
    imageUrl:
    ...
    slug: 'boosting-creativity-through-collaboration',
  },
]

const InsightsListContainer = () => {
  return <InsightsListPresentation blogs={sampleBlogs} />
}
